...
//纪念日
let startDay = "2002/1/28";
//当地拼音,需要在下面的墨迹天气url确认
const local = "shandong/weifang";

//发送者邮箱厂家
let EmianService = "126";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "jerry200299@126.com",
  pass: "CBUJDSQTBXSTDDGM"
};
//发送者昵称与邮箱地址
let EmailFrom = '"暮色沉溺" <jerry200299@126.com>';

//接收者邮箱地
let EmailTo = "1085011285@qq.com";
//邮件主题
